const Board = () => {
	...
	return (
		<div className='game-board' id='game-board' key={1}>
...
const Square = ({ takeTurn, id }) => {
	const catO = (
		<img src='./components/cato.svg' alt='Cat O' className='catPic' />
	);
	const catX = (
		<img src='./components/catx.svg' alt='Cat X' className='catPic' />
	);
	const catNo = (
		<img src='./components/cat.svg' alt='Unmarked' className='catPic' />
	);
	const mark = [catO, catX, catNo];
